...
abstract class BaseListAdapter<T : Any>(
    ...
    protected var itemClickEnabled = true

    fun isItemClickEnabled(bool: Boolean) {
        itemClickEnabled = bool
        notifyDataSetChanged()
    }

    abstract fun onCreateViewHolder(parent: ViewGroup, inflater: LayoutInflater, viewType: Int
